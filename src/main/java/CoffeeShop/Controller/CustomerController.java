...
public class CustomerController {
    ...
    private void clearOrderDetails(){
        ...
        name = null;
        resetDiscount();
        customerUI.getCustomerLabel().setText("Welcome ");
            ...
            if((menuItem != null) && (name != null)){
                ...
                if(n == JOptionPane.YES_OPTION){
                    try {
                        ...
                        copyFile(System.getProperty("user.dir")+prop.getProperty("ResourceLocation")+"orderList.csv");
                        clearOrderDetails();
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if(!customerUI.getCustomerIDField().getText().trim().isEmpty()&&validateNumber(customerUI.getCustomerIDField().getText().trim())){
                if(customer.searchID(Integer.parseInt(customerUI.getCustomerIDField().getText().trim()))!=null){
                    ...
                    customerUI.getCustomerLabel().setText("Welcome "+name.getName());
                }
                else{
