...
import CoffeeShop.Controllers.Customer;
import CoffeeShop.Controllers.Menu;
import CoffeeShop.Controllers.MenuItem;
import CoffeeShop.Controllers.Name;
import CoffeeShop.Controllers.OrderList;
...
//        customer.readCustomerFile("customerList.csv");
    ...
    public void populateTable(String category)
    {
        ...
        //model = (DefaultTableModel) menuItems.getModel();
        menuList = Menu.getInstance().searchCategory(category);
    ...
    private void menuItemsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menuItemsMouseClicked
        ...
        if (row >= 0 && col >= 0) {
            menuItem = Menu.getInstance().searchID(menuItems.getValueAt(row, col).toString());
            if(menuItem!=null){
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        menuItem = Menu.getInstance().searchItem(menuSearch.getText().trim());
        info.setText(menuItem.toString());
            if(menuItem!=null){
                model.setRowCount(0);
                Object rowData[] = new Object[4];
    ...
    private void deleteMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteMenuItemActionPerformed
        // TODO add your handling code here:
            Menu.getInstance().removeMenuItem(menuItem);
            updateMenu();
    ...
    public void updateMenu(){
        ...
        try {
            ...
            menuList = Menu.getInstance().getList();
             ...
             Object[] options = {"Yes", "No"};
                            ...
                            JOptionPane.QUESTION_MESSAGE, null, options, options[1]);
                                if(n == JOptionPane.YES_OPTION){
                                    ...
                                    Menu.getInstance().addMenuItem(menuItem);
                                    updateMenu();
                                    newItem.setText("");
                                    newCost.setText("");
                                    info.setForeground(Color.black);
...
//});
    ...
    private void viewCustomersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewCustomersActionPerformed
        ...
        display.setText(Customer.getInstance().listAllCustomers());
        //display.setText("Customer\t"+"Menu Id\t"+"Item\t"+"Cost\t"+"Date\t\n"+orderList.getTotalSales()+"\n\nTotal Sales: "+orderList.getCost());
    ...
    private void allMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_allMenuActionPerformed
        // TODO add your handling code here:
        model.setRowCount(0);
        menuList = Menu.getInstance().listAllNames();
        Object rowData[] = new Object[4];
        menuList.stream().map((list1) -> {
            rowData[0] = list1.getCategory();
            return list1;
