...
//        } catch (FileNotFoundException ex) {}
    ...
    {
        model.setRowCount(0);
        list = Menu.getInstance().searchCategory(category);
...
//                            
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        MenuItem m = Menu.getInstance().searchItem(customerMenuSearch.getText().trim());
            if(m!=null){
                model.setRowCount(0);
                Object rowData[] = new Object[4];
    ...
    private void searchCustomerIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchCustomerIDActionPerformed
        ...
        if(!customerIDField.getText().trim().isEmpty()&&validateNumber(customerIDField.getText().trim())){
            if(Customer.getInstance().searchID(Integer.parseInt(customerIDField.getText().trim()))!=null){
                name = Customer.getInstance().searchID(Integer.parseInt(customerIDField.getText().trim()));
