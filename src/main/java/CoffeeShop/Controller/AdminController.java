...
public class AdminController {
    ...
    private void updateMenu(){
        ...
        try {
            ...
            writer = new FileWriter(System.getProperty("user.dir")+prop.getProperty("ResourceLocation")+"menu.csv");
    ...
    public void showGUI() {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Thread Server1 = new Thread(new ServerController(1));
                Server1.start();
                try {
                    Thread.sleep(3000);
                ...
                Thread Server2 = new Thread(new ServerController(2));
                Server2.start();
            }
        });
    }
