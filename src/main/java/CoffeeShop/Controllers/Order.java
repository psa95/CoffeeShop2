...
//        menu.readMenuFile("menu.csv");  
        ...
        if(Menu.getInstance().searchID(itemId)!= null&&Customer.getInstance().searchID(customerId)!=null){
         this.menuId = itemId;
         this.customerId = customerId;
         this.cost = Menu.getInstance().searchID(itemId).getCost();
         this.item = Menu.getInstance().searchID(itemId).getItem();
            try { 
